...
export async function postBusinessLines(
  ...
  BusinessLineInfoSchema.strip().parse(body);
...
export async function patchBusinessLinesId(
  ...
  BusinessLineInfoUpdateSchema.strip().parse(body);
  const res = await _request(
    "PATCH",
    `/businessLines/${encodeURIComponent(id)}`,
    { body },
...
export async function postDocuments(
  ...
  DocumentSchema.strip().parse(body);
  const res = await _request(
    "POST",
    "/documents",
    { body, extraHeaders },
...
export async function getDocumentsId(
  ...
  if (params?.skipContent != null)
    searchParams.set("skipContent", String(params.skipContent));
  const res = await _request(
    "GET",
 ...
 * @throws {ApiError<500, ServiceError>}
 */
export async function deleteDocumentsId(
  id: string,
  config?: Partial<ClientConfig>,
): Promise<void> {
...
export async function postLegalEntities(
  ...
  LegalEntityInfoRequiredTypeSchema.strip().parse(body);
  const res = await _request(
    "POST",
    "/legalEntities",
    { body, extraHeaders },
...
export async function patchLegalEntitiesId(
  ...
  LegalEntityInfoSchema.strip().parse(body);
  const res = await _request(
    "PATCH",
    `/legalEntities/${encodeURIComponent(id)}`,
    { body, extraHeaders },
...
export async function getLegalEntitiesIdAcceptedTermsOfServiceDocumentTermsofserviceacceptancereference(
  ...
  if (params?.termsOfServiceDocumentFormat != null)
    searchParams.set(
      ...
      String(params.termsOfServiceDocumentFormat),
    );
  const res = await _request(
    "GET",
...
export async function postLegalEntitiesIdOnboardingLinks(
  ...
  OnboardingLinkInfoSchema.strip().parse(body);
  const res = await _request(
    "POST",
...
export async function postLegalEntitiesIdPciQuestionnairesGeneratePciTemplates(
  ...
  GeneratePciDescriptionRequestSchema.strip().parse(body);
  const res = await _request(
    "POST",
...
export async function postLegalEntitiesIdPciQuestionnairesSignPciTemplates(
  ...
  PciSigningRequestSchema.strip().parse(body);
  const res = await _request(
    "POST",
...
export async function postLegalEntitiesIdPciQuestionnairesSigningRequired(
  ...
  CalculatePciStatusRequestSchema.strip().parse(body);
  const res = await _request(
    "POST",
...
export async function postLegalEntitiesIdSetTaxElectronicDeliveryConsent(
  ...
  SetTaxElectronicDeliveryConsentRequestSchema.strip().parse(body);
  await _request(
    "POST",
...
export async function postLegalEntitiesIdTermsOfService(
  ...
  GetTermsOfServiceDocumentRequestSchema.strip().parse(body);
  const res = await _request(
    "POST",
...
export async function patchLegalEntitiesIdTermsOfServiceTermsofservicedocumentid(
  ...
  AcceptTermsOfServiceRequestSchema.strip().parse(body);
  const res = await _request(
    "PATCH",
...
export async function postTransferInstruments(
  ...
  TransferInstrumentInfoSchema.strip().parse(body);
  const res = await _request(
    "POST",
    "/transferInstruments",
    { body, extraHeaders },
