...
export type TrackRestrictionObject = z.infer<
  typeof TrackRestrictionObjectSchema
>;

export type AlbumRestrictionObject = z.infer<
  typeof AlbumRestrictionObjectSchema
>;

export type EpisodeRestrictionObject = z.infer<
  typeof EpisodeRestrictionObjectSchema
>;

export type ChapterRestrictionObject = z.infer<
  typeof ChapterRestrictionObjectSchema
>;

export type ArtistObject = z.infer<typeof ArtistObjectSchema>;

export type SimplifiedArtistObject = z.infer<
...
export type CurrentlyPlayingContextObject = z.infer<
  typeof CurrentlyPlayingContextObjectSchema
>;
...
export type PagingFeaturedPlaylistObject = z.infer<
  typeof PagingFeaturedPlaylistObjectSchema
>;
...
export type RecommendationSeedObject = z.infer<
  typeof RecommendationSeedObjectSchema
>;
...
export type SimplifiedPlaylistObject = z.infer<
  typeof SimplifiedPlaylistObjectSchema
>;

export type PlaylistTracksRefObject = z.infer<
  typeof PlaylistTracksRefObjectSchema
>;
...
export type ExplicitContentSettingsObject = z.infer<
  typeof ExplicitContentSettingsObjectSchema
>;

export type CurrentlyPlayingObject = z.infer<
  typeof CurrentlyPlayingObjectSchema
>;
