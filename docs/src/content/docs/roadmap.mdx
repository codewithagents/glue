...
The mission of this toolchain is zero-footprint glue between OpenAPI and Zod for both sides of the wire. Every package is a `devDependency` or a peer-dep-only tool. Nothing published here adds bytes to a production bundle that are not already there.
...
<Aside type="note">
  ...
  Open an issue on [GitHub](https://github.com/codewithagents/glue) if something here matters to
  your project.
</Aside>
