...
2.  **Add a config file**
    ...
    Optional fields let you set a default `baseUrl`, enable Zod schemas (`input_schema`), or generate a server-side client factory (`server_client: true`). See the [full options reference](/openapi-gen#options).
