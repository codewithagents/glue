...
| ---------------------------- | -------------------------- | ----------------------------- |
| TypeScript types             | `generated/models.ts`      | Yes, by `openapi-gen`         |
| Fetch client                 | `generated/client.ts`      | Yes, by `openapi-gen`         |
...
<Aside type="note">
  `openapi-gen` is a prerequisite for both `openapi-server` and `openapi-react-query`. Run it first
