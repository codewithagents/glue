...
import { listTasks, createTask, uploadTaskAttachment, getTask, updateTask, deleteTask } from './client.js'
...
export function createServerClient(config: Partial<ClientConfig>) {
  return {
    ...
    uploadTaskAttachment: (body: Parameters<typeof uploadTaskAttachment>[0]) => uploadTaskAttachment(body, config),
